...
class PublicToolProvider(db.Model):
    """
    The table stores the api providers.
    """

    __tablename__ = "tool_public_providers"
    __table_args__ = (
        db.PrimaryKeyConstraint("id", name="tool_public_provider_pkey"),
        db.UniqueConstraint("name", "tenant_id", name="unique_public_tool_provider"),
    )
